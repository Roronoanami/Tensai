...
//     >
//       <div
//         className="w-full max-w-lg rounded-xl bg-white dark:bg-black text-black dark:text-white"
...
//               className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-transparent p-2 outline-none"
//             />
