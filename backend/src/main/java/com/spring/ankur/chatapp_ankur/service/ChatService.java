...
//         if (room.getUser1().equals(currentUser.getUsername())) {
//             otherUsername = room.getUser2();
//         } else {
//             otherUsername = room.getUser1();
//         }
...
//         String lastMessage = "";
//         Instant lastTime = room.getCreatedAt();

//         if (!latestMessages.isEmpty()) {
//             lastMessage = latestMessages.get(0).getContent();
//             lastTime = latestMessages.get(0).getCreatedAt();
//         }

//         long unread = chatMessageRepository
//                 .countByRoomIdAndReceiverUsernameAndReadFalse(
//                         room.getId(),
//                         currentUser.getUsername()
//                 );
...
if (profile != null) {
    profileImage = profile.getProfileImage();
        ...
        long unreadCount =
                chatMessageRepository.countByRoomIdAndReceiverUsernameAndReadFalse(
                        room.getId(),
                        currentUser.getUsername()
                );
